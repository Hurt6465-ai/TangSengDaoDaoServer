...
CREATE TABLE IF NOT EXISTS `dating_profiles` (
  ...
  `native_languages` VARCHAR(1000) NOT NULL DEFAULT '',
  `learning_languages` VARCHAR(1000) NOT NULL DEFAULT '',
  `tags` VARCHAR(3000) NOT NULL DEFAULT '',
  `personality_tags` VARCHAR(2000) NOT NULL DEFAULT '',
  `pet_tags` VARCHAR(2000) NOT NULL DEFAULT '',
  `sport_tags` VARCHAR(2000) NOT NULL DEFAULT '',
  `movie_tags` VARCHAR(2000) NOT NULL DEFAULT '',
  `dealbreakers` VARCHAR(2000) NOT NULL DEFAULT '',
  `photos` VARCHAR(3000) NOT NULL DEFAULT '',
  `card_photos` VARCHAR(3000) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `dating_reports` (
  ...
  `images` VARCHAR(3000) NOT NULL DEFAULT '',
