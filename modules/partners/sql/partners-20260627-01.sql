...
CREATE TABLE IF NOT EXISTS partner_locations (
  ...
  expires_at BIGINT NOT NULL DEFAULT 0 COMMENT '定位过期时间毫秒，默认7天',
...
CREATE TABLE IF NOT EXISTS partner_greetings (
  id BIGINT NOT NULL PRIMARY KEY AUTO_INCREMENT,
  uid VARCHAR(40) NOT NULL DEFAULT '' COMMENT '发起打招呼UID',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='语伴打招呼记录';
